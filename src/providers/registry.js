...
export const SOURCE_CATALOG = [
  ...
  {
    source_id: 'espn',
    source_name: 'ESPN (API publique)',
    source_url: 'https://site.api.espn.com',
    source_type: 'API JSON publique sans clé',
    data_categories: 'fixtures,results,live,teams,leagues',
    coverage: 'Mondiale : Saudi Pro League, Argentine, Brésil, Chine, Japon, Mexique, MLS, A-League, Scandinavie, Afrique du Sud, Indonésie…',
    update_frequency: 'quasi temps réel pendant les matchs',
    terms_status: 'Endpoints JSON publiquement accessibles sans clé ni authentification ; accès mesuré et espacé (≥1,5 s), aucune protection contournée',
    attribution_required: 1,
    attribution_text: 'Résultats et scores : ESPN',
    requires_key: 0,
    test_url: 'https://site.api.espn.com/apis/site/v2/sports/soccer/eng.1/scoreboard',
    notes: 'Utilisé par le moteur de recherche ciblée pour combler les trous de couverture (ligues hors CSV/OpenLigaDB) + suivi live mondial.',
  },
  {

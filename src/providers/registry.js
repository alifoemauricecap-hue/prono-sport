...
export const SOURCE_CATALOG = [
  ...
  {
    source_id: 'espn',
    source_name: 'ESPN (API publique de scores)',
    source_url: 'https://www.espn.com',
    source_type: 'API JSON publique (sans clé)',
    data_categories: 'fixtures,results,live,venues,teams',
    coverage: '33 compétitions mappées et vérifiées : Europe (16 divisions), Saudi Pro League, MLS, Liga MX, Brésil, Argentine, Japon, Chine, A-League, Afrique du Sud, UCL, UEL, Libertadores…',
    update_frequency: 'quasi temps réel pendant les matchs',
    terms_status: 'API publique non documentée, accessible sans clé ni authentification ; usage modéré avec espacement des requêtes (≥1,2 s) et cache',
    attribution_required: 1,
    attribution_text: 'Scores et calendriers complémentaires : ESPN',
    requires_key: 0,
    test_url: 'https://site.api.espn.com/apis/site/v2/sports/soccer/ksa.1/scoreboard',
    notes: 'Source clé du DEEP RESEARCH ENGINE : 1 requête = 1 année complète d\'une ligue (validé en ligne le 2026-09-01). Validation croisée des scores (§6) avec football-data.co.uk et TheSportsDB.',
  },
  {
